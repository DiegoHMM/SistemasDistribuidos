...
public class EmanuelAppl {
    ...
    public EmanuelAppl(boolean flag) {
        ...
        for(int k=0; k<3; k++) {
            ...
            //Se o log estiver vazio, ele publicar� a mensagem e ser� setado para ser o pr�ximo que quer assistir
            ...
            if (flag_log_vazio) {
                ...
                // Se o log n�o estiver vazio ele ir� encontrar o ultimo conteudo do
                ...
                // Ap�s encontrar o ultimo conteudo que tenha algum estado na mensagem
                // se a posi��o que representa quem � o proximo a assistir for maior que zero
                // ou seja, j� temos um pr�ximo a assistir definido, apenas manteremos o valor das posi��es finais do conteudo
                ...
                // se a posi��o que representa quem � o proximo a assistir for zero
                // ent�o podemos definir que o pr�ximo a assistir ser� ele mesmo
                else {
                    String msg =
                            CLIENT_NAME + SEPARATOR +
                                    ESTADO_1 + SEPARATOR +
